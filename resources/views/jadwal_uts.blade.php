...
<head>
    ...
    <title>Jadwal UTS - SimBelWa</title>
    <style>
        /* === RESET & GOOGLE FONTS === */
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        /* Header Kartu (Tahun & Tombol Cetak) */
        .card-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; }
        .academic-year { font-size: 16px; font-weight: 800; color: #0f172a; }
        .btn-print { background-color: #dcfce7; color: #166534; padding: 10px 18px; border-radius: 8px; font-weight: 700; font-size: 13px; text-decoration: none; display: flex; align-items: center; gap: 8px; border: 1px solid #bbf7d0; transition: 0.2s; cursor: pointer; }
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <a href="{{ url('/jadwal-uts') }}" class="nav-item active"><img src="{{ asset('jadwal-uts.png') }}" alt="Jadwal UTS"> Jadwal UTS</a>
    ...
    <div class="main-content">
        <h2 class="page-title">Jadwal Ujian Tengah Semester</h2>
        ...
        <div class="content-card">
            ...
            <div class="card-header">
                ...
                <a href="#" class="btn-print">
                    <img src="{{ asset('pdf.png') }}" alt="Print"> Cetak KPU UTS
                </a>
            </div>
            ...
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        @forelse($jadwal_uts ?? [] as $index => $item)
                        <tr>
                            ...
                            <td class="text-center">{{ $item->waktu_ujian ?? '-' }}</td>
                            <td class="text-center">{{ $item->ruang_ujian ?? '-' }}</td>
                            <td class="text-center">{{ $item->no_duduk ?? '-' }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td class="text-center">1.</td><td class="text-left">INF124404</td><td class="text-left text-dark">Internet Of Thing</td><td class="text-center">C</td><td class="text-center">2</td><td class="text-center">Rabu - 09:40-11:20</td><td class="text-center">FIKLAB-402</td><td class="text-center">14</td>
                        </tr>
                        <tr>
                            <td class="text-center">2.</td><td class="text-left">INF124401</td><td class="text-left text-dark">Keamanan Data dan Jaringan</td><td class="text-center">C</td><td class="text-center">2</td><td class="text-center">Kamis - 13:00-14:40</td><td class="text-center">FIKLAB-304</td><td class="text-center">36</td>
                        </tr>
                        <tr>
                            <td class="text-center">3.</td><td class="text-left">INF124406</td><td class="text-left text-dark">Kecerdasan Buatan</td><td class="text-center">C</td><td class="text-center">3</td><td class="text-center">Jumat - 13:00-16:00</td><td class="text-center">FIK-301</td><td class="text-center">37</td>
                        </tr>
                        <tr>
                            <td class="text-center">4.</td><td class="text-left">INF124411</td><td class="text-left text-dark">Kriptografi (CE.2)</td><td class="text-center">B</td><td class="text-center">3</td><td class="text-center">Senin - 15:30-18:00</td><td class="text-center">FIKLAB-304</td><td class="text-center">37</td>
                        </tr>
                        <tr>
                            <td class="text-center">5.</td><td class="text-left">INF124409</td><td class="text-left text-dark">Matematika Diskrit</td><td class="text-center">C</td><td class="text-center">3</td><td class="text-center">Selasa - 15:30-18:00</td><td class="text-center">FIK-202</td><td class="text-center">35</td>
                        </tr>
                        <tr>
                            <td class="text-center">6.</td><td class="text-left">INF124407</td><td class="text-left text-dark">PBP</td><td class="text-center">C</td><td class="text-center">2</td><td class="text-center">Selasa - 09:40-11:20</td><td class="text-center">FIKLAB-403</td><td class="text-center">35</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <div class="rules-section">
                <div class="rules-title">Ketentuan UTS :</div>
                <ul class="rules-list">
